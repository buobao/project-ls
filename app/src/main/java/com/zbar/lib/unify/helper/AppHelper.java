package com.zbar.lib.unify.helper;
...
import com.zbar.lib.unify.http.IImageDownloader;
import com.zbar.lib.unify.http.ImageHttpUtils;
...
public class AppHelper {
	 ...
	 */
	public static void getBitamp(String url, IImageDownloader imagedownloader) {
		ImageHttpUtils.downloadImage(url, imagedownloader);
	}
}
