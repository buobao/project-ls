...
public class RobGongShouFragment extends HouseListBaseFragment implements HttpInterface {
...
//    private MethodsJni methodsJni;
    ...
    public RobGongShouFragment(GetDataInterface getData,int position) {
    ...
    public void initView() {
        if(HouseListBaseFragment.ROB_GONG_SHOU==viewPosition){
            initData();
        }
    }
    @Override
    ...
    public void initData() {
        if(firstLoading){
            houseListAdapter = new MyHouseListAdapter(mContext, HouseType.GONG_FANG);
