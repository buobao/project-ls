...
public class DianCollectionSFragment extends HouseListBaseFragment implements HttpInterface {
    ...
    public DianCollectionSFragment(int position) {
        this.viewPosition=position;
    }
    public DianCollectionSFragment() {
